...
public class OrderDomainServiceImpl implements OrderDomainService {
    ...
    @Override
    public OrderCanceledEvent cancelOrderPayment(Order order, List<String> failureMessages, DomainEventPublisher<OrderCanceledEvent> orderCanceledEventDomainEventPublisher) {
        order.initCancel(failureMessages);
        log.info("Order payment is canceling with id {}", order.getId().getValue());
